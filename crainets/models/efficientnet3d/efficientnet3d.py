...
class EfficientNet3D(nn.Module):
    ...
    Example:
        ...
        >>> inputs = torch.rand(1, 3, 128, 128, 128)
    ...
    def __init__(self,
        ...
        self.conv_stem = Conv3d(in_channels, out_channels, kernel_size=3, stride=stem_stride, bias=False)
        ...
        self.conv_head = Conv3d(in_channels, out_channels, kernel_size=1, bias=False)
